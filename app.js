...
(function () {
  ...
  function LoginScreen(props) {
    ...
    }, busy && mode === 'login' ? '...' : 'Sign In'), /*#__PURE__*/React.createElement("button", {
      onClick: function () {
        setMode('register');
        setErr('');
        submit();
    ...
    }, busy && mode === 'register' ? '...' : 'Register')), /*#__PURE__*/React.createElement("p", {
  ...
  function RecallCard(props) {
    ...
    }, sourceLabel(r.source)), cls ? /*#__PURE__*/React.createElement("span", {
      className: "text-white text-xs px-2 py-1 rounded font-bold " + classBadge(cls)
    }, "Class ", cls) : null, r.status ? /*#__PURE__*/React.createElement("span", {
      className: "text-white/80 text-xs px-2 py-1 rounded border border-white/30"
    }, r.status) : null), /*#__PURE__*/React.createElement("h3", {
      className: "font-bold text-white text-lg mt-2"
    }, r.brand || 'Unknown firm'), r.product_description ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/90 text-sm mt-1"
    }, r.product_description) : null)), r.reason ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/80 text-sm mt-2"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-white/60"
    }, "Reason: "), r.reason) : null, r.distribution ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/60 text-xs mt-1"
    }, "Distribution: ", r.distribution) : null, r.recall_date ? /*#__PURE__*/React.createElement("p", {
  ...
  function OutbreakCard(props) {
    ...
    }, sourceLabel(o.source)), o.agent ? /*#__PURE__*/React.createElement("span", {
      className: "text-white text-xs px-2 py-1 rounded font-bold bg-emerald-700"
    }, o.agent) : null), /*#__PURE__*/React.createElement("h3", {
      className: "font-bold text-white text-lg mt-2"
    }, o.title || 'Outbreak'), o.summary ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/90 text-sm mt-1"
    }, o.summary) : null)), o.region ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/80 text-sm mt-2"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-white/60"
    }, "Region: "), o.region) : null, o.report_date ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/60 text-xs mt-2"
  ...
  function LatestOutbreaksView(props) {
    ...
    return /*#__PURE__*/React.createElement(PageCard, null, /*#__PURE__*/React.createElement(CardPageHeader, {
      ...
      className: "text-white text-base"
    }, "No recent outbreaks on file."), checkedRel ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/60 text-sm mt-2 italic"
    }, "Last checked ", checkedRel, ". We're watching.") : null) : /*#__PURE__*/React.createElement("div", null, checkedRel ? /*#__PURE__*/React.createElement("p", {
      className: "text-white/60 text-sm text-center mb-3 italic"
  ...
  function AlertsPage(props) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "text-white text-base"
      }, n.message), n.source ? /*#__PURE__*/React.createElement("span", {
        className: "inline-block text-white text-xs px-2 py-1 rounded font-bold mt-2 " + sourceBadgeClass(n.source)
      }, sourceLabel(n.source)) : null, /*#__PURE__*/React.createElement("p", {
        className: "text-white/60 text-xs mt-2"
      }, fmtRelative(n.created_at)), /*#__PURE__*/React.createElement("button", {
        onClick: function () {
          dismiss(n.id);
        },
  ...
  function NavIcon(props) {
    const id = props.id;
    if (id === 'search') return /*#__PURE__*/React.createElement("svg", {
      className: "w-7 h-7",
      fill: "none",
      stroke: "currentColor",
      viewBox: "0 0 24 24"
    ...
    if (id === 'watchlist') return /*#__PURE__*/React.createElement("svg", {
      className: "w-7 h-7",
      fill: "none",
      stroke: "currentColor",
      viewBox: "0 0 24 24"
    ...
    if (id === 'myplaces') return /*#__PURE__*/React.createElement("svg", {
      className: "w-7 h-7",
      fill: "none",
      stroke: "currentColor",
      viewBox: "0 0 24 24"
    ...
    if (id === 'info') return /*#__PURE__*/React.createElement("svg", {
      className: "w-7 h-7",
      fill: "none",
      stroke: "currentColor",
      viewBox: "0 0 24 24"
    ...
    if (id === 'alerts') return /*#__PURE__*/React.createElement("svg", {
      className: "w-7 h-7",
      fill: "none",
      stroke: "currentColor",
      viewBox: "0 0 24 24"
  ...
  function BottomNav(props) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        id: t.id
      }), isAlerts && props.alertCount > 0 ? /*#__PURE__*/React.createElement("span", {
      ...
      }, props.alertCount > 9 ? '9+' : props.alertCount) : null, /*#__PURE__*/React.createElement("span", {
